class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('csv_label_columns', ['class'], 'the name of the label columns in the csv')
        self.define('classes', ['gym', 'operating_room', 'poolinside'],
                    'the names of the output classes. Should match the ones in the csv')
